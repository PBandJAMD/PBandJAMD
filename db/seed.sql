...
INSERT INTO topic (id, title, content, user_id) VALUES
  ...
  (2, 'What is more impressive, being a Navy SEAL or getting into Harvard?', 'Harvard receives tens of thousands of applications per year (just under 40K at this point), and has an acceptance rate of about 6%. This represents over 2000 individuals per year. And the graduation rate is about 86%. Thousands of students graduate from Harvard each year.', 2),
...
ALTER SEQUENCE topic_id_seq RESTART WITH 11;
